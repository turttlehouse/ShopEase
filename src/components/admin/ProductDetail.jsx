    ...
    return (
        <div>
            <div className="py-5 flex justify-between items-center">
                ...
                {/* Add Product Button  */}
                <Link to={'/addproduct'}>
                    <button className="px-5 py-2 bg-blue-50 border border-pink-100 rounded-lg">Add Product</button>
                </Link>
            </div>
                        ...
                        {getAllProduct.map((item, index) => {
                            ...
                            return (
                                <tr key={index} className="text-black-300">
                                    ...
                                    <td onClick={()=> navigate(`/updateproduct/${id}`)} className="h-12 font-bold px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 text-blue-500 cursor-pointer ">
                                        Edit
                                    </td>
                                    <td onClick={()=> deleteProduct(id)} className="h-12 font-bold px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
                                        Delete
                                    </td>
                                </tr>
                            )
